...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='- Stores essential details of companies for measurement service management.\n- Stores client company details: ID, name, address, CEO, business number, and registration date.';
...
CREATE TABLE `stack_measurement` (
  ...
  `cycle_type` enum('monthly','twiceamonth','onceinfebruary','quarterly','semiannual','annual','additonal') NOT NULL,
  `is_completed` tinyint(1) NOT NULL DEFAULT '0',
...
-- Dump completed on 2024-12-15  8:11:05
