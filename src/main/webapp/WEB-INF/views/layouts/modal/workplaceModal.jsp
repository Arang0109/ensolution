...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="workplaceAddLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<c:url value="/manager/company/${company.company_id}"/>" method="post" id="workplace_form" class="needs-validation" novalidate>
        <div class="modal-body m-2">
          ...
          <div class="mb-3 row">
            <label for="inputWorkplace" class="form-label">측정대상 사업장</label>
