package com.ensolution.manager.domain.pollutant;
...
public class PollutantDto {
  ...
  public boolean equals(Object o) {
    ...
    return pollutant_id == that.pollutant_id && Objects.equals(pollutant_name, that.pollutant_name) && Objects.equals(pollutant_name_en, that.pollutant_name_en);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pollutant_id, pollutant_name, pollutant_name_en);
  }
  ...
  public void setPollutant_id(int pollutant_id) {
