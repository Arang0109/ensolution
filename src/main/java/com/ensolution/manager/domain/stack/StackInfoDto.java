...
public class StackInfoDto {
  ...
  public StackInfoDto(Integer stack_info_id, Double diameter, Double dynamic_pressure, Double static_pressure, Double velocity_speed, Double quantity, Double temperature) {
  ...
  public boolean equals(Object o) {
    ...
    StackInfoDto that = (StackInfoDto) o;
